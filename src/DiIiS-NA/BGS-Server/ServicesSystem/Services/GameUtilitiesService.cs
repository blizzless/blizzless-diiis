...
namespace DiIiS_NA.LoginServer.ServicesSystem.Services
{
    public class InitialLoginTask
    {
        ...
        public void run()
        {
            ...
            Init.SetSyncedVars(
                $" OnlineService.Season.Num={seasonNumber}" + //Season number
            ...
            licences.AddLicenses(ContentLicense.CreateBuilder().SetId(1)
                .SetQuantity(1)); // Diablo III Reaper Of Souls - MENU
            ...
            licences.AddLicenses(ContentLicense.CreateBuilder().SetId(4)
                .SetQuantity(1)); // Diablo III Reaper Of Souls - ACT V
    ...
    public class GameUtilitiesService : bgs.protocol.game_utilities.v1.GameUtilitiesService, IServerService
    {
        ...
        public override void ProcessClientRequest(IRpcController controller, ClientRequest request,
            Action<ClientResponse> done)
        {
...
#if DEBUG
            if (messageId != 270)
                Logger.Debug($"$[olive]$ProcessClientRequest({messageId})$[/]$");
#endif
                ...
                case "D3":
                    switch (messageId)
                    {
                        case 0: // HeroDigestListRequest
                            ByteString digest = OnHeroDigestListRequest(((HandlerController)controller).Client,
                                request.GetAttribute(2).Value.MessageValue);
                            attr.SetValue(Variant.CreateBuilder().SetMessageValue(digest));
                            break;
                        case 1: // CreateHero
                            ByteString hero = OnHeroCreateParams(((HandlerController)controller).Client,
                                request.GetAttribute(2).Value.MessageValue);
                            if (hero != null)
                            ...
                            break;
                        case 2: // DeleteHero
                            ByteString hero1 = OnHeroDeleteParams(((HandlerController)controller).Client,
                                request.GetAttribute(2).Value.MessageValue);
                            attr.SetValue(Variant.CreateBuilder().SetMessageValue(hero1));
                            break;
                        case 3: // Hero Select
                            ByteString switchHero = SwitchCharRequest(((HandlerController)controller).Client,
                                request.GetAttribute(2).Value.MessageValue);
                        ...
                        case 4: //D3.GameMessages.SaveBannerConfiguration -> return MessageId with no Message
                            SaveBanner(((HandlerController)controller).Client,
                                request.GetAttribute(2).Value.MessageValue);
                            var attrId = bgs.protocol.Attribute.CreateBuilder()
                                .SetName("CustomMessageId")
                                .SetValue(Variant.CreateBuilder().SetIntValue(5).Build())
                                .Build();
                        ...
                        case 8:
                            var setAccountSettings = SetGameAccountSettings(
                                D3.GameMessage.SetGameAccountSettings.ParseFrom(request.GetAttribute(2).Value
                                    .MessageValue), ((HandlerController)controller).Client);
                            attr.SetValue(Variant.CreateBuilder().SetMessageValue(setAccountSettings)
                                .Build());
                            break;
                        case 9: // GetToonSettings -> ToonSettings
                            ByteString toonSettings = OnGetToonSettings(((HandlerController)controller).Client,
                                request.GetAttribute(2).Value.MessageValue);
                            attr.SetValue(Variant.CreateBuilder().SetMessageValue(toonSettings));
                            break;
                        case 10: // SetToonSettings -> Empty Message???
                            ByteString Current = GetAchievements(((HandlerController)controller).Client,
                                request.GetAttribute(2).Value.MessageValue);
                        ...
                        case 14: //D3.GameMessage.GetAccountProfiles
                            var getprofile1 = CollectProfiles(((HandlerController)controller).Client,
                                request.GetAttribute(2).Value.MessageValue);
                        ...
                        case 15: //D3.GameMessage.GetHeroProfiles -> D3.Profile.HeroProfileList
                            ...
                            var heroprofs = GetHeroProfs(((HandlerController)controller).Client,
                                request.GetAttribute(2).Value.MessageValue);
                            attr.SetValue(Variant.CreateBuilder().SetMessageValue(heroprofs));
                            break;
                        case 16: // GetAccountPrefs -> (D3.Client.)Preferences
                            ByteString prefs = OnGetAccountPrefs(((HandlerController)controller).Client,
                                request.GetAttribute(2).Value.MessageValue);
                        ...
                        case 19: // Getting all cosmetics
                            ByteString CurrentToon = GetCollectionAccout(((HandlerController)controller).Client,
                                request.GetAttribute(2).Value.MessageValue);
                            attr.SetValue(Variant.CreateBuilder().SetMessageValue(CurrentToon));
                            break;
                        case 23: //Information about dead characters
                            var herodeadprofs = GetDeadedHeroProfs(((HandlerController)controller).Client,
                                request.GetAttribute(2).Value.MessageValue);
                            attr.SetValue(Variant.CreateBuilder().SetMessageValue(herodeadprofs));

                            var attr2 = bgs.protocol.Attribute.CreateBuilder();
                            var heroAddedDigests = GetDeadedHeroDigests(((HandlerController)controller).Client,
                                request.GetAttribute(2).Value.MessageValue);
                        ...
                        case 29: //Set Cosmetic
                            ByteString Current1 = SetCollection(((HandlerController)controller).Client,
                                request.GetAttribute(2).Value.MessageValue);
                            attr.SetValue(Variant.CreateBuilder().SetMessageValue(Current1));
                            break;
                        case 32: //ChallengeRift Fetch HeroData
                            ByteString ChallengeRift = GetChallengeRift(((HandlerController)controller).Client,
                                request.GetAttribute(2).Value.MessageValue);
                            attr.SetValue(Variant.CreateBuilder().SetMessageValue(ChallengeRift));
                            break;
                        case 33: //Rebirth
                            ByteString RebirthResponse = RebirthMethod(((HandlerController)controller).Client,
                                request.GetAttribute(2).Value.MessageValue);
                            attr.SetValue(Variant.CreateBuilder().SetMessageValue(RebirthResponse));
                            break;
                        case 120: //Creation of a guild
                            ByteString CreatedGuild = CreateGuild(((HandlerController)controller).Client,
                                request.GetAttribute(2).Value.MessageValue);
                            attr.SetValue(Variant.CreateBuilder().SetMessageValue(CreatedGuild));
                            break;
                        case 121: //TODO: Clan invitation
                            ByteString GSuggest = GuildInvit(((HandlerController)controller).Client,
                                request.GetAttribute(2).Value.MessageValue);
                            attr.SetValue(Variant.CreateBuilder().SetMessageValue(GSuggest).Build());
                            break;
                        case 122: //Joining a Guild
                            ByteString InvitedToGuild = AcceptInviteToGuild(((HandlerController)controller).Client,
                                request.GetAttribute(2).Value.MessageValue);
                            attr.SetValue(Variant.CreateBuilder().SetMessageValue(InvitedToGuild));
                            break;
                        case 124: //TODO: Clan message of the day
                            GuildSetMOTD(((HandlerController)controller).Client,
                                GuildSetMotd.ParseFrom(request.GetAttribute(2).Value.MessageValue));
                            break;
                        case 125: //TODO: Add clan news
                            GuildSetNews(((HandlerController)controller).Client,
                                D3.GameMessage.GuildSetNews.ParseFrom(request.GetAttribute(2).Value.MessageValue));
                            break;
                        case 127: //Rank changes
                            break;
                        case 129: //Rank promotion
                            var promote = GuildPromoteMember(((HandlerController)controller).Client,
                                D3.GameMessage.GuildPromoteMember.ParseFrom(request.GetAttribute(2).Value
                                    .MessageValue));
                            attr.SetValue(Variant.CreateBuilder().SetMessageValue(promote).Build());
                            break;
                        case 130: //Rank demotion
                            var demote = GuildDemoteMember(((HandlerController)controller).Client,
                                D3.GameMessage.GuildDemoteMember.ParseFrom(request.GetAttribute(2).Value.MessageValue));
                            attr.SetValue(Variant.CreateBuilder().SetMessageValue(demote).Build());
                            break;
                        case 132: //Guild kick
                            ByteString ExitFrGuild = ExitFromGuild(((HandlerController)controller).Client,
                                request.GetAttribute(2).Value.MessageValue);
                            attr.SetValue(Variant.CreateBuilder().SetMessageValue(ExitFrGuild));
                            break;
                        case 133: //Kick from the clan
                            GuildKickMemberP(((HandlerController)controller).Client,
                                GuildKickMember.ParseFrom(request.GetAttribute(2).Value.MessageValue));
                            break;
                        case 134: //Disbanding a clan
                            GuildDisband(((HandlerController)controller).Client,
                                GuildId.ParseFrom(request.GetAttribute(2).Value.MessageValue));
                            break;
                        case 138: //Guild creation
                            ByteString createCommunity = CreateCommunity(((HandlerController)controller).Client,
                                request.GetAttribute(2).Value.MessageValue);
                            attr.SetValue(Variant.CreateBuilder().SetMessageValue(createCommunity));
                            break;
                        case 144: //TODO: Guild information
                            GuildSetDescription(((HandlerController)controller).Client,
                                D3.GameMessage.GuildSetDescription.ParseFrom(request.GetAttribute(2).Value
                                    .MessageValue));
                            break;
                        case 146: //TODO: 
                            var inviteList = GetInviteList(((HandlerController)controller).Client,
                                GuildId.ParseFrom(request.GetAttribute(2).Value.MessageValue));
                            attr.SetValue(Variant.CreateBuilder().SetMessageValue(inviteList).Build());
                            break;
                        case 148: //Request to join the guild
                            ByteString guildSuggest = GuildSuggest(((HandlerController)controller).Client,
                                D3.GameMessage.GuildSuggest.ParseFrom(request.GetAttribute(2).Value.MessageValue));
                            ...
                            break;
                        case 149:
                            GuildSuggestionResponse(((HandlerController)controller).Client,
                                D3.GameMessage.GuildSuggestionResponse.ParseFrom(request.GetAttribute(2).Value
                                    .MessageValue));
                            break;
                        case 150: // Clan news
                            ByteString news = GuildFetchNews(((HandlerController)controller).Client,
                                D3.GameMessage.GuildFetchNews.ParseFrom(request.GetAttribute(2).Value.MessageValue));
                        ...
                        case 152: //Cancel request to join the guild
                            GuildCancelInvite(((HandlerController)controller).Client,
                                D3.GameMessage.GuildCancelInvite.ParseFrom(request.GetAttribute(2).Value.MessageValue));
                            break;
                        case 156: //Guild settings change
                            GuildLFM(((HandlerController)controller).Client,
                                GuildSetLFM.ParseFrom(request.GetAttribute(2).Value.MessageValue));
                            break;
                        case 190: //Search Guild
                            ByteString guildSearch = SearchGuilds(((HandlerController)controller).Client,
                                request.GetAttribute(2).Value.MessageValue);
                            attr.SetValue(Variant.CreateBuilder().SetMessageValue(guildSearch));
                            break;
                        case 200: //Rating
                            ByteString rating = GetRating(((HandlerController)controller).Client,
                                request.GetAttribute(2).Value.MessageValue);
                            attr.SetValue(Variant.CreateBuilder().SetMessageValue(rating));
                            break;
                        case 201: //Rating1
                            ByteString ratingAlt = GetRatingAlt(((HandlerController)controller).Client,
                                request.GetAttribute(2).Value.MessageValue);
                            attr.SetValue(Variant.CreateBuilder().SetMessageValue(ratingAlt));
                            break;
                        case 202: //personal rating
                            ByteString personalRating = GetRatingPersonal(((HandlerController)controller).Client,
                                request.GetAttribute(2).Value.MessageValue);
                            attr.SetValue(Variant.CreateBuilder().SetMessageValue(personalRating));
                            break;
                        case 210:
                            ByteString storeResponse = CurrentStore(((HandlerController)controller).Client,
                                request.GetAttribute(2).Value.MessageValue);
                            attr.SetValue(Variant.CreateBuilder().SetMessageValue(storeResponse));
                            break;
                        case 211:
                            ByteString storeResponse1 = CurrentStore1(((HandlerController)controller).Client,
                                request.GetAttribute(2).Value.MessageValue);
                            attr.SetValue(Variant.CreateBuilder().SetMessageValue(storeResponse1));
                            break;
                        case 212: //Purchase
                            ByteString currentWalletResponse = CurrentWallet(((HandlerController)controller).Client,
                                request.GetAttribute(2).Value.MessageValue);
                            attr.SetValue(Variant.CreateBuilder().SetMessageValue(currentWalletResponse));
                            break;
                        case 213: //Real currency
                            ByteString currentPrimaryWalletResponse = CurrentPrimaryWallet(
                                ((HandlerController)controller).Client, request.GetAttribute(2).Value.MessageValue);
                            attr.SetValue(Variant.CreateBuilder().SetMessageValue(currentPrimaryWalletResponse));
                            break;
                        case 216: //Collection
                            ByteString test = TestRequest(((HandlerController)controller).Client,
                                request.GetAttribute(2).Value.MessageValue);
                            attr.SetValue(Variant.CreateBuilder().SetMessageValue(test));
                            break;
                        case 230: //GetAchievementSnapshot
                            var GetAchievementsSnapshot = CollectAchivementsSnapshot(
                                ((HandlerController)controller).Client, request.GetAttribute(2).Value.MessageValue);
                            attr.SetValue(Variant.CreateBuilder().SetMessageValue(GetAchievementsSnapshot));
                            break;
                        case 250: //Purchase
                            ByteString SwitchParams = SwitchParameters(((HandlerController)controller).Client,
                                request.GetAttribute(2).Value.MessageValue);
                            attr.SetValue(Variant.CreateBuilder().SetMessageValue(SwitchParams));
                            break;
                        case 270: //Purchase
                            ByteString TestResponse = SendWarden3Custom(((HandlerController)controller).Client,
                                request.GetAttribute(2).Value.MessageValue);
        ...
        public override void GetAchievementsFile(IRpcController controller, GetAchievementsFileRequest request,
            Action<GetAchievementsFileResponse> done)
        {
            throw new NotImplementedException();
        }

        public override void GetAllValuesForAttribute(IRpcController controller,
            GetAllValuesForAttributeRequest request, Action<GetAllValuesForAttributeResponse> done)
        {
            throw new NotImplementedException();
        }

        public override void GetPlayerVariables(IRpcController controller, GetPlayerVariablesRequest request,
            Action<GetPlayerVariablesResponse> done)
        {
            throw new NotImplementedException();
        }

        public override void OnGameAccountOffline(IRpcController controller, GameAccountOfflineNotification request,
            Action<NO_RESPONSE> done)
        {
            throw new NotImplementedException();
        }

        public override void OnGameAccountOnline(IRpcController controller, GameAccountOnlineNotification request,
            Action<NO_RESPONSE> done)
        {
            throw new NotImplementedException();
        }

        public override void PresenceChannelCreated(IRpcController controller, PresenceChannelCreatedRequest request,
            Action<NoData> done)
        {
            throw new NotImplementedException();
        }

        public override void ProcessServerRequest(IRpcController controller, ServerRequest request,
            Action<ServerResponse> done)
        {
            throw new NotImplementedException();
        }
        ...
        {
            var request = LeaderboardGetHeroSnapshot.ParseFrom(data);
            var response = LeaderboardGetHeroSnapshotResponse.CreateBuilder();
            bool season = false;
            bool hardcore = false;
            ...
            switch (request.LeaderboardId)
            {
                case 1:
                    break;
                case 2:
                    neededClass = ToonClass.Barbarian;
                    break; // Barbarian
                case 3:
                    neededClass = ToonClass.Crusader;
                    break; // Crusader
                case 4:
                    neededClass = ToonClass.DemonHunter;
                    break; // Demon Hunter
                case 5:
                    neededClass = ToonClass.Monk;
                    break; // Monk
                case 6:
                    neededClass = ToonClass.WitchDoctor;
                    break; // Witch Doctor
                case 7:
                    neededClass = ToonClass.Wizard;
                    break; // Wizard
                case 8:
                    neededClass = ToonClass.Necromancer;
                    break; // Necromancer
            ...
            switch (request.ScopeId)
            {
                ...
                case 4:
                    season = true;
                    hardcore = true;
                    break; //Hardcore and Seasonal
            }

            List<DBGameAccount> gameAccounts = DBSessions.SessionQuery<DBGameAccount>()
                .Where(a => a.Id == request.GameAccountId).ToList();
            var heroes =
                ToonManager.GetToonsForGameAccount(GameAccountManager.GetGameAccountByDBGameAccount(gameAccounts[0]));
            Toon hero = null;
            byte upLevel = 0;
            int idx = -1;
            if (heroes.Count > 0)
            {
                ...
                {
                    if (season && !heroes[i].IsSeasoned) continue;
            ...
            if (hero != null)
            {
                var Snapshot = D3.Leaderboard.HeroSnapshot.CreateBuilder()
                    ...
                    .AddCosmeticItems(D3.Leaderboard.HeroCosmeticItem.CreateBuilder().SetCosmeticVisualInventorySlot(2)
                        .SetGbid(hero.Cosmetic2))
                    .AddCosmeticItems(D3.Leaderboard.HeroCosmeticItem.CreateBuilder().SetCosmeticVisualInventorySlot(3)
                        .SetGbid(hero.Cosmetic3))
        ...
        {
            var request = LeaderboardFetchScores.ParseFrom(data);
            ...
            foreach (var gameAccountId in request.GameAccountIdsList)
            {
                ...
                var Heroes =
                    ToonManager.GetToonsForGameAccount(GameAccountManager.GetGameAccountByDBGameAccount(gameAccount));
                Toon Hero = null;
                byte upLevel = 0;
                int idx = -1;
                if (Heroes.Count > 0)
                ...
                if (Hero != null)
                    try
                    {
                        ...
                        {
                            member.SetClanId(gameAccount2.Clan.GuildId.GuildId_).SetClanTag(gameAccount2.Clan.Prefix)
                                .SetClanName(gameAccount2.Clan.Name);
                        }

                        response
                            .AddEntry(D3.Leaderboard.Score.CreateBuilder()
                                .SetGameAccountId(gameAccount2.AccountId)
                                .SetScore_((ulong)Hero.Level +
                                           (ushort)gameAccount2.DBGameAccount.ParagonLevel) // Temporary Separation.
                                .SetScoreBand(5)
                                .SetLeaderboardId(5)
                                .SetScopeId(5)
                                ...
                                .SetMetadata(D3.Leaderboard.Metadata.CreateBuilder()
                                    ...
                                    .SetChallengeData(D3.Leaderboard.WeeklyChallengeData.CreateBuilder()
                                        ...
                                        .SetGameAccountId(GameAccountHandle.CreateBuilder()
                                            .SetId(unchecked((uint)gameAccount2.BnetEntityId.Low)).SetProgram(17459)
                                            .SetRegion(1))
        ...
        private ByteString GetRating(BattleClient client, ByteString data)
        {
            ...
            foreach (var gameAccountId in gameAccounts)
            {
                ...
                if (toons.Count > 0)
                {
                    ...
                    {
                        if (season && !toons[i].IsSeasoned) continue;
        ...
        private ByteString SwitchCharRequest(BattleClient client, ByteString data)
        {
            ...
            var response = SelectHero.CreateBuilder().SetHeroId(request.HeroId);
            return response.Build().ToByteString();
        }
        ...
        private ByteString CreateGuild(BattleClient client, ByteString data)
        {
            ...
            var guild = GuildManager.CreateNewGuild(client.Account.GameAccount, request.Name, request.Tag, true, 0,
                request.LookingForMembers, request.Language);
            if (guild != null)
            {
			...
			*/
            ...
            if (guild != null)
            {
                ...
                foreach (var news in guild_news)
                {
                    ...
                    var post = D3.Guild.News.CreateBuilder().SetNewsId(news.Id).SetAccountId(news.DBGameAccount.Id)
                        .SetNewsType((uint)news.Type).SetNewsTime(news.Time);
        ...
        private void GuildSetMOTD(BattleClient client, GuildSetMotd request)
        {
            var guild = GuildManager.GetGuildById(request.GuildId);
        ...
        private void GuildSetNews(BattleClient client, GuildSetNews request)
        {
            var guild = GuildManager.GetGuildById(request.GuildId);
            if (guild != null && guild.HasMember(client.Account.GameAccount))
            {
        ...
        private ByteString GuildSuggest(BattleClient client, GuildSuggest request)
        {
        ...
        private void GuildSetDescription(BattleClient client, GuildSetDescription request)
        {
            var guild = GuildManager.GetGuildById(request.GuildId);
            if (guild != null && guild.HasMember(client.Account.GameAccount))
            {
        ...
        private void GuildSuggestionResponse(BattleClient client, GuildSuggestionResponse request)
        {
        ...
        private ByteString GetInviteList(BattleClient client, GuildId guild_id)
        {
        ...
        private void GuildCancelInvite(BattleClient client, GuildCancelInvite request)
        {
            var guild = GuildManager.GetGuildById(request.GuildId);
            if (guild != null)
            {
        ...
        private void GuildLFM(BattleClient client, GuildSetLFM request)
        {
            var guild = GuildManager.GetGuildById(request.GuildId);
            if (guild != null && guild.HasMember(client.Account.GameAccount))
            {
        ...
        {
            var request = GetAccountProfile.ParseFrom(data);
        ...
        {
            var request = AchievementsGetSnapshot.ParseFrom(data);
            ...
            return AchievementsSnapshot.CreateBuilder().SetErrorCode(0).SetGameAccountId(request.GameAccountId)
                .SetSnapshot(snapshot).Build().ToByteString();
        }
        ...
        private ByteString GetCollectionAccout(BattleClient client, ByteString data)
        {
            ...
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2431587061))); // Angelic
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2431587101))); // Aranea
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2586361111))); // Barbarian
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2350702305))); // Base Frame
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2608693639))); // Blood Shard
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2608693641))); // Blood Shard))); // Champion
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2608693643))); // Blood Shard))); // Conqueror
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2608693642))); // Blood Shard))); // Destroyer
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2608693644))); // Blood Shard))); // Guardian
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2608693640))); // Blood Shard))); // Slayer
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2431587063))); // Bone
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2431587102))); // Caldeum
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)789315589))); // Call to Adventure
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)789315590))); // Call to Adventure))); // Slayer
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)789315591))); // Call to Adventure))); // Champion
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)789315593))); // Call to Adventure))); // Conqueror
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)789315592))); // Call to Adventure))); // Destroyer
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)789315594))); // Call to Adventure))); // Guardian
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)3111787208))); // Classic Angel
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)3115028404))); // Classic Demon
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1666320302))); // Crusader
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2431587062))); // Deathshead
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1834718654))); // Demon Hunter
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)949147387))); // Eternal Conflict
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)949147388))); // Eternal Conflict))); // Slayer
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)949147389))); // Eternal Conflict))); // Champion
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)949147391))); // Eternal Conflict))); // Conqueror
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)949147390))); // Eternal Conflict))); // Destroyer
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)949147392))); // Eternal Conflict))); // Guardian
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)466824271))); // Eternal Woods
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)466824272))); // Eternal Woods))); // Slayer
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)466824273))); // Eternal Woods))); // Champion
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)466824275))); // Eternal Woods))); // Conqueror
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)466824274))); // Eternal Woods))); // Destroyer
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)466824276))); // Eternal Woods))); // Guardian
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2914281823))); // Greyhollow
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2914281824))); // Greyhollow))); // Slayer
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2914281825))); // Greyhollow))); // Champion
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2914281827))); // Greyhollow))); // Conqueror
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2914281826))); // Greyhollow))); // Destroyer
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2914281828))); // Greyhollow))); // Guardian
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2431587099))); // Heart of Darkness
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)409592463))); // Heaven
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)409592464))); // Heaven))); // Slayer
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)409592465))); // Heaven))); // Champion
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)409592467))); // Heaven))); // Conqueror
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)409592466))); // Heaven))); // Destroyer
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)409592468))); // Heaven))); // Guardian
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)586020310))); // Hell
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)586020311))); // Hell))); // Slayer
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)586020312))); // Hell))); // Champion
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)586020313))); // Hell))); // Destroyer
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)586020314))); // Hell))); // Conqueror
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)586020315))); // Hell))); // Guardian
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2174954790))); // Imperius
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2174954791))); // Imperius))); // Slayer
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2174954792))); // Imperius))); // Champion
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2174954794))); // Imperius))); // Conqueror
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2174954793))); // Imperius))); // Destroyer
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2174954795))); // Imperius))); // Guardian
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)4111980878))); // Industrial
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2431587128))); // Jade Serpent
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2431587066))); // Molten
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)423580970))); // Monk
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1094085036))); // Necromancer
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)604200072))); // Overwatch
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2129557709))); // Pandemonium
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2129557710))); // Pandemonium))); // Slayer
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2129557711))); // Pandemonium))); // Champion
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2129557713))); // Pandemonium))); // Conqueror
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2129557712))); // Pandemonium))); // Destroyer
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2129557714))); // Pandemonium))); // Guardian
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2350702306))); // Paragon 1
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)263764818))); // Paragon 10
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)114304450))); // Paragon 100
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)263764851))); // Paragon 20
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)114305539))); // Paragon 200
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)263764884))); // Paragon 30
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)114306628))); // Paragon 300
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)263764917))); // Paragon 40
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)114307717))); // Paragon 400
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)263764950))); // Paragon 50
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)114308806))); // Paragon 500
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)263764983))); // Paragon 60
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)114309895))); // Paragon 600
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)263765016))); // Paragon 70
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)114310984))); // Paragon 700
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)263765049))); // Paragon 80
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)114312073))); // Paragon 800
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)263765082))); // Paragon 90
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1103438361))); // Portrait of Valor
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2431587097))); // Season 3
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2914245886))); // Season 4
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2914245888))); // Season 4))); // Champion
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2914245890))); // Season 4))); // Conqueror
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2914245889))); // Season 4))); // Destroyer
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2914245891))); // Season 4))); // Guardian
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2914245887))); // Season 4))); // Slayer
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2431587127))); // Sescheron
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)360887075))); // Soulstone
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)360887077))); // Soulstone))); // Champion
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)360887079))); // Soulstone))); // Conqueror
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)360887078))); // Soulstone))); // Destroyer
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)360887080))); // Soulstone))); // Guardian
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)360887076))); // Soulstone))); // Slayer
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2431587068))); // Stained Glass))); // Azure
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2431587094))); // Stained Glass))); // Orange
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2431587095))); // Stained Glass))); // Purple
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2431587069))); // Stained Glass))); // Red
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2431587067))); // Stained Glass))); // Teal
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2431587093))); // Stained Glass))); // Yellow
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2431587098))); // Storm
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1898911879))); // Tal Rasha
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1898911880))); // Tal Rasha))); // Slayer
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1898911881))); // Tal Rasha))); // Champion
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1898911883))); // Tal Rasha))); // Conqueror
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1898911882))); // Tal Rasha))); // Destroyer
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1898911884))); // Tal Rasha))); // Guardian
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1079851844))); // Teganze Warrior
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2431587126))); // The Sign of Rakkis
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2431587064))); // Thorns
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)3661137118))); // Treasure Goblin
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)3661137119))); // Treasure Goblin))); // Slayer
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)3661137120))); // Treasure Goblin))); // Champion
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)3661137122))); // Treasure Goblin))); // Conqueror
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)3661137121))); // Treasure Goblin))); // Destroyer
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)3661137123))); // Treasure Goblin))); // Guardian
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)4140821779))); // Triforce
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2001444264))); // Twitch
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2431587100))); // Viper's Seal
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2431587096))); // Whimsyshire Portrait Frame
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2819867039))); // Witch Doctor
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2102838278))); // Wizard
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)3526887646))); // Zandalari
            //Pets
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2923223637))); // Bat
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)567166426))); // Angelic Goblin
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)3358761128))); // Az-Lo
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)3620943091))); // Belphegor
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)291388178))); // Bile Boy
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2767458423))); // Blaine's Bear
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1336361309))); // Blaze
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)988742338))); // Bones
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)291388177))); // Buddy
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)167459531))); // Butcher
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1497375554))); // Captain Maraca
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1209305989))); // Charlotte
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)937125523))); // Cucco
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1369935753))); // Diablo
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)3922872439))); // Dominion's Revenge
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)471039389))); // Dream of Piers
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1404174869))); // Emerald Serpent
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)3620943090))); // Friendly Gauntlet
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)291388175))); // Frost Hound
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2327409917))); // Galthrak the Unhinged
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)3153829279))); // Garluth, Destroyer of Kneecaps
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)909568905))); // Grunkk
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)3258626648))); // Half-formed Golem
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)4084520547))); // Haunting Hannah
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1336361310))); // Humbart Wessel
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1404174868))); // Iron Serpent
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1404174867))); // Jade Serpent
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)3620943089))); // Knight Hand
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1508058349))); // Lady Morthanlu
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1967180567))); // Lamb
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)3132731524))); // Liv Moore
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2767458419))); // Lord Kek La Mort
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1508058348))); // Lord Nedly
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)347688656))); // Malfeasance
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1514497706))); // Mal'Ganis
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1377380860))); // Minaca the Feared
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2767458418))); // Mr. Bear
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)3430307999))); // Ms. Madeleine
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2401672920))); // Murkgoblin
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)3870322527))); // Old Growth
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2767458421))); // Overseer Lady Josephine
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)517654224))); // Probe
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)3094528011))); // Queen of the Succubi
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1168709051))); // Rocky
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1729774130))); // Royal Calf
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)3919201454))); // Shadow Diablo
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)291388174))); // Spike
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2431587065))); // Steadfast
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1920516661))); // Stupendous Contraption
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)3536793764))); // Tal'darim Probe
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2647152737))); // Ten Pounder
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2768450096))); // That Which Must Not be Named
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)291388179))); // The Black Dog
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)3475456761))); // The Bumble
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)95923716))); // The Stomach
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)291388176))); // Tiger Hound
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)471039390))); // Unihorn
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2767458422))); // Xiansai Bear
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)3620943088))); // Zayl's Loss
            //Wings
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)3372877841))); // Knights of Westmarch
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1464422747))); // Blade Wings
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)567892925))); // Anguish's Grasp        
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2222542490))); // Auriel's Favor
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)702834904))); // Blue Horror
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)702834901))); // Brimstone Ascendant
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1905890384))); // Cosmic Wings
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)702834903))); // Dark Bat
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1464422100))); // Demon Soaring
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)702834905))); // Dread
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2653514096))); // Echoes of the Mask
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)208405024))); // Eldritch Embrace
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)3890992984))); // Embrace of the Pure One
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1464439640))); // Eternal Flame
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1081301157))); // Eternal Light
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1081297790))); // Falcon's Wings
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)550271606))); // Fiacla-Géar
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)262300867))); // Fingers of Flame
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2479192435))); // Fingers of Terror
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)546207131))); // Galactic
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)211305012))); // Harbinger of Destruction
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1905890379))); // Lady Gaki's Wings
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)3273442495))); // Lilith's Embrace
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1905890378))); // Lord Culsu's Wings
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1335990173))); // Mercy's Gaze
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)702834906))); // Osseous Grasp
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)208454467))); // Pieces of Hatred
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2552747379))); // Prime Evil Wings
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2764892181))); // Skeletal Wings
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2029657407))); // Star Wings
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)702834902))); // Sulfuric Tide
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2840660586))); // The Light of Heaven
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)3297867693))); // The Mimic
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2222725144))); // The Pillars of Heaven
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)721772994))); // Trag'Oul Wings
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1905890383))); // Winds of Aldinach
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1905890380))); // Wings of Kokabiel
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1905890381))); // Wings of Lempo
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2036418836))); // Wings of Mastery
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)550271607))); // Wings of Northern Skies
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1905890382))); // Wings of Semyaz
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1185806158))); // Wings of Terror
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2590476058))); // Wings of the Betrayer
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)726768249))); // Wings of the Crypt Guardian
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)671128753))); // Wings of the Dedicated
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)4188235898))); // Wings of the Ghost Queen
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1030142027))); // Wings of Valor
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2015178386))); // Heaven's Might

            //1514497706

            //Flags
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1428615110))); // Barbarian
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)895083523))); // Barbarian Ascendant
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)3194995136))); // BlizzCon 2015
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)3484863475))); // Blood Master
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)522011784))); // Crusader
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)938178597))); // Crusader Ascendant
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)566077307))); // Demon Hunter
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)28429688))); // Demon Hunter Ascendant
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)177825848))); // Diablo
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)177825849))); // Diablo II
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)177825850))); // Diablo III
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2113242414))); // Dog
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)218434287))); // Dragon
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)590649887))); // Goat
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)4211285172))); // Harvest
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)127020830))); // Heroes of the Storm
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2644729685))); // Horse
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)177825852))); // Lord of Destruction
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1156357301))); // Loremaster
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)3269693700))); // Monk
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)895493953))); // Monk Ascendant
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1375359175))); // Monkey
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)3829241798))); // Necromancer
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)671111717))); // Necromancer Ascendant
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1769352763))); // Ox
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2575751604))); // Pig
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)4233838312))); // Rabbit
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2645002203))); // Rat
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)177825851))); // Reaper of Souls
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)455845058))); // Rooster
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)3124785508))); // Samhain
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2732665546))); // Season 3
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1329910150))); // Snake
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)3359438927))); // Tiger
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2885511819))); // Tyrael's Justice
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)3532272868))); // Warsong Pennant
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)2626988266))); // Witch Doctor
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)28430311))); // Witch Doctor Ascendant
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)1114884937))); // Wizard
            C.AddCosmeticItems_(D3.CosmeticItems.CosmeticItem.CreateBuilder()
                .SetGbid(unchecked((int)938200550))); // Wizard Ascendant
            //*/
        ...
        private ByteString CurrentPrimaryWallet(BattleClient client, ByteString data)
        {
            ...
            var testresp2 = D3.Store.GetPaymentMethodsResponse.CreateBuilder()
                    .AddWallets(D3.Store.Wallet.CreateBuilder().SetPrimary(true).SetWalletId(840)
                        .SetWalletName("US Dollar").SetFixedPointBalance(50))
        ...
        private ByteString CurrentStore(BattleClient client, ByteString data)
        {
            ...
            responseCategoriese.AddCategories(D3.Store.ProductCategory.CreateBuilder().SetCategory(0)
                .SetNewestProductTime(0x6E1199DE92C0000)); //Popular
            ...
            responseCategoriese.AddCategories(D3.Store.ProductCategory.CreateBuilder().SetCategory(10)
                .SetNewestProductTime(0x72A0D8B7AD90000)); //Wings
            responseCategoriese.AddCategories(D3.Store.ProductCategory.CreateBuilder().SetCategory(11)
                .SetNewestProductTime(0x725C16B88870000)); //Pets
            responseCategoriese.AddCategories(D3.Store.ProductCategory.CreateBuilder().SetCategory(12)
                .SetNewestProductTime(0)); //Framework
            responseCategoriese.AddCategories(D3.Store.ProductCategory.CreateBuilder().SetCategory(13)
                .SetNewestProductTime(0)); //Flags
            responseCategoriese.AddCategories(D3.Store.ProductCategory.CreateBuilder().SetCategory(14)
                .SetNewestProductTime(0)); //Strengthening the Hero
            responseCategoriese.AddCategories(D3.Store.ProductCategory.CreateBuilder().SetCategory(15)
                .SetNewestProductTime(0)); //Hero Cells
            responseCategoriese.AddCategories(D3.Store.ProductCategory.CreateBuilder().SetCategory(16)
                .SetNewestProductTime(0)); //Stash Tabs
        ...
        private ByteString CurrentStore1(BattleClient client, ByteString data)
        {
            ...
            {
                store
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(
                            D3.Store.ProductEntitlement.CreateBuilder()
                                .SetGbid(unchecked((int)2036418836))) // Wings of Mastery
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(50000000)
                            .SetFixedPointRetailPrice(50000000)) //Value Type, Discount Price, Regular Price
                    ...
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(
                            D3.Store.ProductEntitlement.CreateBuilder()
                                .SetGbid(unchecked((int)3194995136))) // Blizzcon 2015
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(15000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(13).SetFeatured(1).SetBundleLabel("")
                        .SetProductId(130002))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(
                            D3.Store.ProductEntitlement.CreateBuilder().SetGbid(unchecked((int)1514497706))) // MalGanis
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(70000000)
                            .SetFixedPointRetailPrice(80000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(11).SetFeatured(2).SetBundleLabel("")
                        .SetProductId(11000))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(
                            D3.Store.ProductEntitlement.CreateBuilder().SetGbid(unchecked((int)2431587061))) // Angelic
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(2000000)
                            .SetFixedPointRetailPrice(5000000)) //Value Type, Discount Price, Regular Price
            ...
            if (request.Category == 1)
            {
                store
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder().SetPlatinumAmount(500))
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(15).SetFixedPointCost(50000)
                            .SetFixedPointRetailPrice(50000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(1).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(11383))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder().SetPlatinumAmount(1000))
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(15).SetFixedPointCost(80000)
                            .SetFixedPointRetailPrice(80000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(1).SetFeatured(1).SetBundleLabel("")
                        .SetProductId(11384))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder().SetPlatinumAmount(5000))
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(15).SetFixedPointCost(299900)
                            .SetFixedPointRetailPrice(350000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(1).SetFeatured(1).SetBundleLabel("")
                        .SetProductId(11385))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder().SetPlatinumAmount(10000))
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(15).SetFixedPointCost(499900)
                            .SetFixedPointRetailPrice(499900)) //Value Type, Discount Price, Regular Price
                        .SetCategory(1).SetFeatured(1).SetBundleLabel("")
                        .SetProductId(11386))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder().SetPlatinumAmount(50000))
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(15).SetFixedPointCost(0)
                            .SetFixedPointRetailPrice(990000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(1).SetFeatured(1).SetBundleLabel("")
                        .SetProductId(11387))
                    ;
            }
            ...
            if (request.Category == 10)
            {
                store
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder().SetGbid(1905890383))
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(20000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(10).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(1))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder().SetGbid(1905890380))
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(20000000)
                            .SetFixedPointRetailPrice(20000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(10).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(2))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder().SetGbid(1905890381))
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(20000000)
                            .SetFixedPointRetailPrice(20000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(10).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(3))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder()
                            .SetGbid(2036418836)) // Wings of Mastery
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(50000000)
                            .SetFixedPointRetailPrice(50000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(10).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(4))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder().SetGbid(550271607))
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(20000000)
                            .SetFixedPointRetailPrice(20000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(10).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(5))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder().SetGbid(1185806158))
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(20000000)
                            .SetFixedPointRetailPrice(20000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(1).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(6))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(
                            D3.Store.ProductEntitlement.CreateBuilder().SetGbid(unchecked((int)2590476058)))
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(20000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(10).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(7))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder().SetGbid(671128753))
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(20000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(10).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(8))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(
                            D3.Store.ProductEntitlement.CreateBuilder().SetGbid(unchecked((int)4188235898)))
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(20000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(10).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(9))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(
                            D3.Store.ProductEntitlement.CreateBuilder().SetGbid(unchecked((int)1030142027)))
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(20000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(10).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(10))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder().SetGbid(721772994))
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(20000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(10).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(11))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder().SetGbid(567892925))
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(20000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(10).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(12))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder().SetGbid(1464422747))
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(20000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(10).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(13))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder().SetGbid(1905890384))
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(20000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(10).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(14))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder().SetGbid(1081297790))
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(20000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(10).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(15))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder().SetGbid(1905890379))
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(20000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(10).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(16))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder().SetGbid(1905890378))
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(20000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(10).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(17))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(
                            D3.Store.ProductEntitlement.CreateBuilder().SetGbid(unchecked((int)2764892181)))
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(20000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(10).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(18))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder().SetGbid(2029657407))
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(20000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(10).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(19))
            ...
            if (request.Category == 12)
            {
                store
                    ...
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder()
                            .SetGbid(unchecked((int)604200072))) // OverWatch
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(3000000)
                            .SetFixedPointRetailPrice(5000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(12).SetBundleLabel("")
                        .SetProductId(12001))
                    ;
            ...
            if (request.Category == 13)
            {
                store
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder().SetGbid(1428615110)) // 
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(15000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(13).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(130000))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder().SetGbid(895083523)) // 
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(15000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(13).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(130001))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(
                            D3.Store.ProductEntitlement.CreateBuilder().SetGbid(unchecked((int)3194995136))) // 
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(15000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(13).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(130002))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(
                            D3.Store.ProductEntitlement.CreateBuilder().SetGbid(unchecked((int)3484863475))) // 
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(15000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(13).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(130003))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder().SetGbid(522011784)) // 
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(15000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(13).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(130004))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder().SetGbid(938178597)) // 
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(15000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(13).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(130005))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder().SetGbid(566077307)) // 
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(15000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(13).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(130006))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder().SetGbid(28429688)) // 
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(15000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(13).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(130007))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder().SetGbid(177825848)) // 
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(15000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(13).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(130008))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder().SetGbid(177825849)) // 
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(15000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(13).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(130009))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder().SetGbid(177825850)) // 
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(15000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(13).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(130010))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder().SetGbid(2113242414)) // 
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(15000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(13).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(130011))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder().SetGbid(218434287)) // 
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(15000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(13).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(130012))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder().SetGbid(590649887)) // 
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(15000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(13).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(130013))
                    ...
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(
                            D3.Store.ProductEntitlement.CreateBuilder().SetGbid(unchecked((int)4211285172))) // 
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(15000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(13).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(130015))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder().SetGbid(127020830)) // 
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(15000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(13).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(130016))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(
                            D3.Store.ProductEntitlement.CreateBuilder().SetGbid(unchecked((int)2644729685))) // 
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(15000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(13).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(130017))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder().SetGbid(177825852)) // 
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(15000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(13).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(130018))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder().SetGbid(1156357301)) // 
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(15000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(13).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(130019))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(
                            D3.Store.ProductEntitlement.CreateBuilder().SetGbid(unchecked((int)3269693700))) // 
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(15000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(13).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(130020))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder().SetGbid(895493953)) // 
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(15000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(13).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(130021))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder().SetGbid(1375359175)) // 
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(15000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(13).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(130022))
                    ...
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(
                            D3.Store.ProductEntitlement.CreateBuilder().SetGbid(unchecked((int)3829241798))) // 
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(15000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(13).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(130024))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder()
                            .SetGbid(unchecked((int)671111717))) // 
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(15000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(13).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(130025))
                    ...
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(
                            D3.Store.ProductEntitlement.CreateBuilder().SetGbid(unchecked((int)2575751604))) // 
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(15000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(13).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(130027))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(
                            D3.Store.ProductEntitlement.CreateBuilder().SetGbid(unchecked((int)4233838312))) // 
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(15000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(13).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(130028))
                    ...
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder()
                            .SetGbid(unchecked((int)177825851))) // 
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(15000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(13).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(130030))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder()
                            .SetGbid(unchecked((int)455845058))) // 
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(15000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(13).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(130031))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(
                            D3.Store.ProductEntitlement.CreateBuilder().SetGbid(unchecked((int)3124785508))) // 
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(15000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(13).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(130032))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(
                            D3.Store.ProductEntitlement.CreateBuilder().SetGbid(unchecked((int)2732665546))) // 
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(15000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(13).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(130033))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(
                            D3.Store.ProductEntitlement.CreateBuilder().SetGbid(unchecked((int)1329910150))) // 
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(15000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(13).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(130034))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(
                            D3.Store.ProductEntitlement.CreateBuilder().SetGbid(unchecked((int)3359438927))) // 
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(15000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(13).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(130035))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(
                            D3.Store.ProductEntitlement.CreateBuilder().SetGbid(unchecked((int)2885511819))) // 
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(15000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(13).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(130036))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(
                            D3.Store.ProductEntitlement.CreateBuilder().SetGbid(unchecked((int)3532272868))) // 
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(15000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(13).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(130037))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(
                            D3.Store.ProductEntitlement.CreateBuilder().SetGbid(unchecked((int)2626988266))) // 
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(15000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(13).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(130038))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder()
                            .SetGbid(unchecked((int)28430311))) // 
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(15000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(13).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(130039))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(
                            D3.Store.ProductEntitlement.CreateBuilder().SetGbid(unchecked((int)1114884937))) // 
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(15000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(13).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(130040))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder()
                            .SetGbid(unchecked((int)938200550))) // 
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(15000000)
                            .SetFixedPointRetailPrice(15000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(13).SetFeatured(0).SetBundleLabel("")
                        .SetProductId(130041))
            ...
            if (request.Category == 14)
            {
                store
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder().SetContentLicenseId(16)) // 
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(60000000)
                            .SetFixedPointRetailPrice(60000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(14).SetDurationSecs(2592000)
                        .SetProductId(12101))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder().SetContentLicenseId(16)) // 
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(0)
                            .SetFixedPointRetailPrice(20000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(14).SetDurationSecs(604800)
                        .SetProductId(12102))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder().SetContentLicenseId(17)) // 
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(60000000)
                            .SetFixedPointRetailPrice(60000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(14).SetDurationSecs(2592000)
                        .SetProductId(12103))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        ...
                        .SetProductId(12104))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder().SetContentLicenseId(18)) // 
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(60000000)
                            .SetFixedPointRetailPrice(60000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(14).SetDurationSecs(2592000)
                        .SetProductId(12105))
            ...
            if (request.Category == 15)
            {
                store
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder().SetContentLicenseId(11)
                            .SetMaxStackCount(10))
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(100000000)
                            .SetFixedPointRetailPrice(100000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(15)
                        .SetProductId(15000))
                    ;
            }
            ...
            if (request.Category == 16)
            {
                store
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder().SetContentLicenseId(14)
                            .SetMaxStackCount(5))
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder().SetPlatinumAmount(0))
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(20000000)
                            .SetFixedPointRetailPrice(20000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(16)
                        .AddMaxContentlicensesAllowed(D3.Store.ContentLicenseRestriction.CreateBuilder()
                            .SetContentLicenseId(14).SetCount(0))
                        .SetProductId(160))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder().SetContentLicenseId(14)
                            .SetMaxStackCount(5))
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(40000000)
                            .SetFixedPointRetailPrice(40000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(16)
                        .AddMaxContentlicensesAllowed(D3.Store.ContentLicenseRestriction.CreateBuilder()
                            .SetContentLicenseId(14).SetCount(1))
                        .AddMinContentlicensesRequired(D3.Store.ContentLicenseRestriction.CreateBuilder()
                            .SetContentLicenseId(14).SetCount(1))
                        .SetProductId(161))
                    .AddProducts(D3.Store.Product.CreateBuilder()
                        .AddEntitlements(D3.Store.ProductEntitlement.CreateBuilder().SetContentLicenseId(14)
                            .SetMaxStackCount(5))
                        .AddPrices(D3.Store.ProductPrice.CreateBuilder().SetCurrency(26).SetFixedPointCost(80000000)
                            .SetFixedPointRetailPrice(80000000)) //Value Type, Discount Price, Regular Price
                        .SetCategory(16)
                        .AddMinContentlicensesRequired(D3.Store.ContentLicenseRestriction.CreateBuilder()
                            .SetContentLicenseId(14).SetCount(2))
                        .SetProductId(162))
                    ;
            }
            ...
            //Currencies
            store
                .AddCurrencies(D3.Store.Currency.CreateBuilder().SetCode("GBP").SetId(826).SetSymbol("GBP")
                    .SetName("Pound Sterling"))
                .AddCurrencies(D3.Store.Currency.CreateBuilder().SetCode("NZD").SetId(554).SetSymbol("NZD")
                    .SetName("New Zealand Dollar"))
                .AddCurrencies(D3.Store.Currency.CreateBuilder().SetCode("CLP").SetId(152).SetSymbol("CLP")
                    .SetName("Chilean Peso"))
                .AddCurrencies(D3.Store.Currency.CreateBuilder().SetCode("TPT").SetId(16).SetSymbol("NT$")
                    .SetName("TPT"))
                .AddCurrencies(D3.Store.Currency.CreateBuilder().SetCode("CAD").SetId(124).SetSymbol("CAD")
                    .SetName("Canadian Dollar"))
                .AddCurrencies(D3.Store.Currency.CreateBuilder().SetCode("KRW").SetId(410).SetSymbol("KRW")
                    .SetName("Won"))
                .AddCurrencies(D3.Store.Currency.CreateBuilder().SetCode("USD").SetId(840).SetSymbol("USD")
                    .SetName("US Dollar"))
                .AddCurrencies(D3.Store.Currency.CreateBuilder().SetCode("JPY").SetId(392).SetSymbol("JPY")
                    .SetName("Yen"))
                .AddCurrencies(D3.Store.Currency.CreateBuilder().SetCode("MXN").SetId(484).SetSymbol("MXN")
                    .SetName("Mexican Peso"))
                .AddCurrencies(D3.Store.Currency.CreateBuilder().SetCode("BRL").SetId(986).SetSymbol("BRL")
                    .SetName("Brazilian Real"))
                .AddCurrencies(D3.Store.Currency.CreateBuilder().SetCode("AUD").SetId(36).SetSymbol("AUD")
                    .SetName("Australian Dollar"))
                .AddCurrencies(D3.Store.Currency.CreateBuilder().SetCode("CAD").SetId(124).SetSymbol("CAD")
                    .SetName("Canadian Dollar"))
                .AddCurrencies(D3.Store.Currency.CreateBuilder().SetCode("EUR").SetId(978).SetSymbol("EUR")
                    .SetName("Euro"))
                .AddCurrencies(D3.Store.Currency.CreateBuilder().SetCode("ARS").SetId(32).SetSymbol("ARS")
                    .SetName("Argentine Peso"))
                .AddCurrencies(D3.Store.Currency.CreateBuilder().SetCode("RUB").SetId(643).SetSymbol("RUB")
                    .SetName("Russian Ruble"))
                .AddCurrencies(D3.Store.Currency.CreateBuilder().SetCode("CPT").SetId(15).SetSymbol("¥").SetName("CPT"))
                .AddCurrencies(D3.Store.Currency.CreateBuilder().SetCode("XDC").SetId(26).SetSymbol("$")
                    .SetName("D3 Platinum"))
                ;
        ...
        {
            var request = EquipCosmeticItem.ParseFrom(data);
            ...
            {
                D3.Hero.VisualCosmeticItem.CreateBuilder().SetGbid(client.Account.GameAccount.CurrentToon.Cosmetic1)
                    .Build(), // Wings
                D3.Hero.VisualCosmeticItem.CreateBuilder().SetGbid(client.Account.GameAccount.CurrentToon.Cosmetic2)
                    .Build(), // Flag
                D3.Hero.VisualCosmeticItem.CreateBuilder().SetGbid(client.Account.GameAccount.CurrentToon.Cosmetic3)
                    .Build(), // Pet
                D3.Hero.VisualCosmeticItem.CreateBuilder().SetGbid(client.Account.GameAccount.CurrentToon.Cosmetic4)
                    .Build(), // Frame
            };
            ...
            var NewVisual = D3.Hero.VisualEquipment.CreateBuilder()
                .AddRangeVisualItem(
                    client.Account.GameAccount.CurrentToon.HeroVisualEquipmentField.Value.VisualItemList)
                .AddRangeCosmeticItem(RangeCosmetic).Build();

            client.Account.GameAccount.CurrentToon.HeroVisualEquipmentField.Value = NewVisual;
            client.Account.GameAccount.ChangedFields.SetPresenceFieldValue(client.Account.GameAccount.CurrentToon
        ...
        private ByteString TestRequest(BattleClient client, ByteString data)
        {
            ...
            var Snap = D3.CS.HeroesList.CreateBuilder().SetCurrentSeasonNum(1).SetCurrentSeasonState(1)
                .SetDigests(HeroDigestList);
        ...
        {
            var request = MatchmakingGetStats.ParseFrom(data);
                ...
                .SetEquipment(D3.Items.ItemList.CreateBuilder()
                    .AddItems(D3.Items.SavedItem.CreateBuilder()
                        ...
                        .SetGenerator(D3.Items.Generator.CreateBuilder()
                            .SetSeed(3437070505)
                            .SetGbHandle(
                                D3.GameBalance.Handle.CreateBuilder().SetGameBalanceType(2).SetGbid(1104405863))
                            ...
                            .AddContents(D3.Items.EmbeddedGenerator.CreateBuilder()
                                ...
                                .SetGenerator(D3.Items.Generator.CreateBuilder()
                                    .SetSeed(2696508178)
                                    .SetGbHandle(D3.GameBalance.Handle.CreateBuilder().SetGameBalanceType(2)
                                        .SetGbid(-1038303580))
                                    .SetFlags(436491)
                                    .SetDurability(0)
                                    .SetStackSize(1)
...
challenge_end_time_unix_seconds: 1583200800
        ...
        private static BNetPacket GetPacketFromHexByteArray(byte[] bytemessage)
        {
            ...
            DotNetty.Codecs.Http.WebSockets.BinaryWebSocketFrame msg =
                new DotNetty.Codecs.Http.WebSockets.BinaryWebSocketFrame(BB);
