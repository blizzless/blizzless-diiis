...
{
    [Message(new[] { Opcodes.HirelingSwapAgreeMessage }, Consumers.Player)]
    public class HirelingSwapAgreeMessage : GameMessage
    {
        public int NewClass;

        public HirelingSwapAgreeMessage() : base(Opcodes.HirelingSwapAgreeMessage)
        {
        }
