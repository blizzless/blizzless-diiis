...
namespace DiIiS_NA.GameServer.GSSystem.GameSystem
{
    ...
    public class Game : IMessageConsumer
    {
        ...
        /// <summary>
        /// Lists all quests and verify if <param name="id">Quest Id</param> is valid
        ///
        /// - 11 Act I
        /// - 10 Act II
        /// - 8 Act III
        ...
        /// <returns>If the quest is valid.</returns>
        public bool HasQuest(int id)
        {
            return id switch
            {
                // ACT 1
                87700 or 72095 or 72221 or 72061 or 117779 or 72738 or 73236 or 72546 or 72801 or 136656 or
                // ACT 2
                80322 or 93396 or 74128 or 57331 or 78264 or 78266 or 57335 or 57337 or 121792 or 57339 or
                // ACT 3
                93595 or 93600 or 93697 or 203595 or 101756 or 101750 or 101758 or
                // ACT 4
                112498 or 113910 or 114208 or 114901 or
                // ACT 5
                251355 or 284683 or 285098 or 257120 or 263851 or 273790 or 269552 or 273408 or
                // Open World
                312429 or 382695 or 337492 => true,
                _ => false
            };
        }

        /// <summary>
        /// Tries to get act by quest id
        /// </summary>
        /// <param name="questId">Quest Id</param>
        /// <param name="act">Act Id</param>
        /// <returns>Whether it was successfully found</returns>
        public bool TryGetActByQuestId(int questId, out ActEnum? act)
        {
            act = questId switch
            {
                87700 or 72095 or 72221 or 72061 or 117779 or 72738 or 73236 or 72546 or 72801 or 136656 =>
                    ActEnum.Act1,
                80322 or 93396 or 74128 or 57331 or 78264 or 78266 or 57335 or 57337 or 121792 or 57339 => ActEnum.Act2,
                93595 or 93600 or 93697 or 203595 or 101756 or 101750 or 101758 => ActEnum.Act3,
                112498 or 113910 or 114208 or 114901 => ActEnum.Act4,
                251355 or 284683 or 285098 or 257120 or 263851 or 273790 or 269552 or 273408 => ActEnum.Act5,
                312429 or 382695 or 337492 => ActEnum.OpenWorld,
                _ => null
            };
            return act != null;
        }
        ...
        /// <summary>
        /// Retrieves the list of quest identifiers associated with the specified act.
        /// </summary>
        /// <param name="actId">The identifier of the act for which to retrieve quest IDs. Valid values correspond to supported act IDs;
        /// unsupported values return a default array.</param>
        /// <returns>An array of integers representing the quest IDs for the specified act. Returns an array containing 0 if the
        /// act ID is not recognized.</returns>
        public int[] GetQuestsByActId(int actId)
        {
            return actId switch
            {
                0 => _questsOrderA1,
                ...
                300 => _questsOrderA4,
                400 => _questsOrderA5,
                3000 => _questsOrderOpenWorld,
                _ => new[] {0}
            };
        }

        /// <summary>
        /// Gets the current act name, optionally with its ID
        /// </summary>
        /// <param name="showId">Show ID</param>
        /// <param name="currentAct">If not set, <see cref="CurrentAct"/> will be used.</param>
        /// <returns>Current Act name + Optional ID</returns>
        public string GetCurrentActName(bool showId = false, int? currentAct = null)
        {
            currentAct ??= CurrentAct;
            string append = "";
            if (showId) append = $" ({currentAct})";
            var act = currentAct switch
            {
                0 => $"Act I",
                100 => $"Act II",
                200 => $"Act III",
        ...
        /// <summary>
        /// Displays a string with the current act name and quest name, optionally with their IDs
        /// </summary>
        /// <param name="showId">Show Act Id and Quest Id</param>
        ...
        /// <summary>
        /// Checks if the act is valid or not
        /// </summary>
        /// <param name="currentAct">The value of the current act or the <see cref="CurrentAct"/> will be used.</param>
        /// <returns>Whether the act is valid or not.</returns>
        public bool IsValidAct(int? currentAct = null) => (currentAct ?? CurrentAct) is 0 or 100 or 200 or 300 or 400 or 3000;
